...
def backgroud(img):
    ...
    bkg = Background2D(img, (100, 100), filter_size=(3, 3),sigma_clip=sigma_clip, bkg_estimator=bkg_estimator,mask=mask1)
...
def combine_process(filename,ipath,calpath,opath,libpath,date):
    ...
    bkg1,bkgrms1=backgroud(flat_corrected1)
    
    bkg_sub1= flat_corrected1-bkg1
 
    bkg2,bkgrms2=backgroud(flat_corrected2)
